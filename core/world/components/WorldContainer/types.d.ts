...
export type WorldCameraOption = Pick<CameraOptionType, 'distance' | 'xDistance' | 'yDistance' | 'zDistance' | 'fov' | 'zoom' | 'enableZoom' | 'minZoom' | 'maxZoom' | 'zoomSpeed' | 'enableCollision'> & {
    type: CameraType;
    height?: number;
    smoothness?: number;
};
