...
export type NetworkMessageType = 'room.join' | 'room.leave' | 'avatar.position' | 'chat.message' | 'emote.play' | 'interaction.trigger' | 'world.visitSnapshot' | 'ledger.command' | NetworkAuthorityMessageType;
...
export declare function createNetworkEnvelope<TPayload>(type: NetworkMessageType, payload: TPayload, options?: Partial<Omit<NetworkMessageEnvelope<TPayload>, 'type' | 'payload' | 'sentAt'>>): NetworkMessageEnvelope<TPayload>;
