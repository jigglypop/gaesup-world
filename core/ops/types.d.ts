...
export type CreatorRole = 'owner' | 'admin' | 'developer' | 'designer' | 'moderator' | 'viewer';
export type RbacPermission = 'workspace:read' | 'workspace:manage' | 'content:edit' | 'content:validate' | 'content:publish' | 'content:rollback' | 'asset:upload' | 'asset:approve' | 'moderation:read' | 'moderation:resolve' | 'analytics:read';
