export type AssetKind = 'characterPart' | 'weapon' | 'material' | 'tile' | 'wall' | 'object3d';
export type AssetSlot = 'body' | 'hair' | 'hat' | 'top' | 'bottom' | 'shoes' | 'face' | 'weapon' | 'shield' | 'accessory' | 'glasses';
