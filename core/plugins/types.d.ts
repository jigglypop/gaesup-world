...
export type PluginStatus = 'registered' | 'setting-up' | 'ready' | 'disposing' | 'disposed' | 'failed';
...
export interface GridExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface PlacementExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface CatalogExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface AssetExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface RenderingExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface InputExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface InteractionExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface NPCExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface QuestExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface BlueprintExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface EditorExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface SaveExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface ServiceExtensionMap {
    readonly [extensionMapBrand]?: never;
}
export interface SystemExtensionMap {
    readonly [extensionMapBrand]?: never;
}
...
export type PluginDiagnosticKind = 'capability-conflict' | 'missing-capability';
