...
export type PhysicsCalculationProps = Required<Pick<PhysicsEntityProps, 'rigidBodyRef'>> & Pick<PhysicsEntityProps, 'innerGroupRef' | 'outerGroupRef' | 'colliderRef' | 'groundRay' | 'colliderSize'>;
