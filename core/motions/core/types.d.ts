...
export type characterConfigType = Pick<PhysicsConfigType, 'walkSpeed' | 'runSpeed' | 'jumpSpeed' | 'jumpGravityScale' | 'normalGravityScale' | 'airDamping' | 'stopDamping'>;
export type vehicleConfigType = Pick<PhysicsConfigType, 'maxSpeed' | 'accelRatio' | 'brakeRatio' | 'linearDamping'>;
export type airplaneConfigType = Pick<PhysicsConfigType, 'gravityScale' | 'angleDelta' | 'maxAngle' | 'maxSpeed' | 'accelRatio'>;
