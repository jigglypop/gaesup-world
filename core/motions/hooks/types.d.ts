...
export type GltfAndSizeOptions = {
    url?: string;
};
...
export interface UsePhysicsEntityProps extends Pick<PhysicsEntityProps, 'onIntersectionEnter' | 'onIntersectionExit' | 'onCollisionEnter' | 'userData' | 'outerGroupRef' | 'innerGroupRef' | 'colliderRef' | 'groundRay' | 'onFrame' | 'onAnimate' | 'onReady'> {
