export type { ResidentId, HouseId, Resident, HousePlotState, HousePlot as HousePlotData, TownStats, TownSerialized, } from './types';
export { createTownPlugin, hydrateTownState, serializeTownState, townPlugin, } from './plugin';
