import { NPCSystemState, NPCTemplate, NPCInstance, NPCCategory, NPCAnimation, NPCPart, NPCVolumeConfig, NPCBrainConfig, NPCPerceptionConfig, NPCBehaviorConfig, NPCAction, NPCObservation, NPCBrainDecision, NPCBrainBlueprint } from "../types";
