...
export interface NPCTemplate {
    ...
    fullModelUrl?: string;
    baseParts: NPCPart[];
    clothingParts: NPCPart[];
    accessoryParts?: NPCPart[];
    defaultAnimation?: string;
    defaultClothingSet?: string;
}
...
export type NPCBrainBlueprintNode = {
    ...
    type: 'condition';
    label?: string;
    condition: NPCBrainBlueprintCondition;
} | {
    id: string;
    type: 'action';
    label?: string;
    action: NPCAction | {
        type: 'moveToTarget';
        target: NPCBrainBlueprintTarget;
        speed?: number;
        animationId?: string;
    };
};
