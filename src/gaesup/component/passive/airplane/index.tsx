...
export function PassiveAirplane({ props }: { props: gaesupPassivePropsType }) {
  ...
  return (
    <PassiveWrapperRef props={props} refs={refs} url={props.url?.airplaneUrl}>
      <AirplaneCollider collider={props.airplaneCollider} />
    </PassiveWrapperRef>
  );
}
