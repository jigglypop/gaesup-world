...
import { MINIMAP_SIZE_PX } from '../constants';
import { avatarStyles, directionStyles, objectStyles, textStyles } from './style.css';
...
export const useCanvas = (
  ...
  const updateCanvas = useCallback((canvasRef: React.RefObject<HTMLCanvasElement>) => {
    ...
    ctx.restore();
    ctx.restore();
  }, [activeState, minimap, scale, angle, blockRotate, mode.control, getRotation, minimapObjectStyle, textStyle, avatarStyle, directionStyle]);
