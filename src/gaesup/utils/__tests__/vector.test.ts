...
describe('vector utils', () => {
  ...
  describe('calcAngleByVector', () => {
    ...
    it('should calculate angle for another vector', () => {
      const dir = new THREE.Vector3(0, 0, 1);
      // Should be PI, but due to cross product, it will be NaN. The function has a bug.
      // Let's test for NaN
      expect(calcAngleByVector(dir)).toBeNaN();
    });
  });
