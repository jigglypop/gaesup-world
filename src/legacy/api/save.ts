...
export const postThreeObjecSaveRoom = async (
  request: saveThreeObjectRequestType
) => {
  const api = APIBuilder.post(`/three_object/save`, request)
    .baseURL(SERVER_URL)
    .setAuth()
    .build();
...
export const postNpcSaveRoom = async (request: saveNpcRequestType) => {
  const api = APIBuilder.post(`/npc/save`, request)
    .baseURL(SERVER_URL)
    .setAuth()
    .build();
...
export const postTileSaveRoom = async (request: saveTileRequestType) => {
  const api = APIBuilder.post(`/tile/save`, request)
    .baseURL(SERVER_URL)
    .setAuth()
    .build();
...
export const postWallSaveRoom = async (request: saveWallRequestType) => {
  const api = APIBuilder.post(`/wall/save`, request)
    .baseURL(SERVER_URL)
    .setAuth()
    .build();
...
export const postPortalSaveRoom = async (request: savePortalRequestType) => {
  const api = APIBuilder.post(`/portal/save`, request)
    .baseURL(SERVER_URL)
    .setAuth()
    .build();
