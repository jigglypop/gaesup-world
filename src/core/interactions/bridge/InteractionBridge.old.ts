...
export class InteractionBridge {
  ...
  private handleInputCommand(command: BridgeCommand): void {
    ...
    switch (action) {
      case 'updateKeyboard':
        ...
        break;
      case 'updateMouse':
        console.log('InteractionBridge - updateMouse data:', data);
        this.interactionSystem.updateMouse(data as Partial<MouseState>);
        console.log('InteractionBridge - after updateMouse, mouse state:', this.interactionSystem.getMouseRef());
        this.notifyListeners();
        break;
      case 'updateGamepad':
  ...
  private notifyListeners(): void {
    ...
    console.log('InteractionBridge - notifyListeners, eventListeners count:', this.eventListeners.size);
    console.log('InteractionBridge - notifyListeners, mouse state:', mouse);
