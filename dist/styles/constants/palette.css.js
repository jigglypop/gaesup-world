...
// boxShadow theme
export var themeShadow = {
    bg: "0 0 10px ".concat(vars.themes.background),
    tr: "0 0 10px ".concat(vars.themes.text.reverse),
    t: "0 0 10px ".concat(vars.themes.text.normal),
    g: "0 0 10px ".concat(vars.themes.glass.normal),
    gr: "0 0 10px ".concat(vars.themes.glass.reverse),
    ta: "0 0 10px ".concat(vars.themes.textarea),
    sb: "0 0 10px ".concat(vars.themes.scrollBarTrack),
    sm: "0 0 10px ".concat(vars.themes.sunmoon),
    c: "0 0 10px ".concat(vars.themes.code),
    tag: "0 0 10px ".concat(vars.themes.tag),
};
export var themeShadowHover = {
    bg_hover: "0 0 20px ".concat(vars.themes.background),
    tr_hover: "0 0 20px ".concat(vars.themes.text.reverse),
    t_hover: "0 0 20px ".concat(vars.themes.text.normal),
    g_hover: "0 0 20px ".concat(vars.themes.glass.normal),
    gr_hover: "0 0 20px ".concat(vars.themes.glass.reverse),
    ta_hover: "0 0 20px ".concat(vars.themes.textarea),
    sb_hover: "0 0 20px ".concat(vars.themes.scrollBarTrack),
    sm_hover: "0 0 20px ".concat(vars.themes.sunmoon),
    c_hover: "0 0 20px ".concat(vars.themes.code),
    tag_hover: "0 0 20px ".concat(vars.themes.tag),
};
