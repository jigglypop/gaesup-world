...
export function orbitDirection(_a) {
    var activeState = _a.activeState, control = _a.control, mode = _a.mode, joystick = _a.joystick, clicker = _a.clicker, clickerOption = _a.clickerOption;
...
export default function direction(prop) {
    var worldContext = prop.worldContext;
