...
export default function calculation(prop) {
    ...
    useFrame(function (state, delta) {
        ...
        if (block.control)
            return null;
        var calcProp = __assign(__assign({}, prop), { state: state, delta: delta, worldContext: worldContext, controllerContext: controllerContext, dispatch: dispatch, matchSizes: getSizesByUrls(controllerContext === null || controllerContext === void 0 ? void 0 : controllerContext.urls) });
