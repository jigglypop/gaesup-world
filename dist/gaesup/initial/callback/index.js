...
export default function initCallback(_a) {
    var props = _a.props;
    var _b = useContext(GaesupWorldContext), characterGltf = _b.characterGltf, characterAnimations = _b.animations, activeState = _b.activeState, states = _b.states, control = _b.control;
