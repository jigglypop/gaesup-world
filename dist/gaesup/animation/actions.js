...
export default function playActions(_a) {
    ...
    var resetAni = function () { return playAnimation("idle"); };
    var playIdle = function () { return playAnimation("idle"); };
    var playWalk = function () { return playAnimation("walk"); };
    var playRun = function () { return playAnimation("run"); };
    var playJump = function () { return playAnimation("jump"); };
    var playFall = function () { return playAnimation("fall"); };
    var playRide = function () { return playAnimation("ride"); };
    useEffect(function () {
        return function () {
            resetAni();
        };
