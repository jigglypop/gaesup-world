            ...
            if (e.deltaY <= 0)
                ...
                downscale();
                        ...
                        : "translate(-50%, -50%) rotate(".concat((activeState.euler.y * 180) / Math.PI + 180, "deg) ") }, innerStyle), children: [" ", _jsx("div", { className: "east direction", style: __assign({ transform: props.blockRotate || mode.control === "normal"
                                ...
                                ? "translate(-50%, -50%) rotate(180deg) "
                                : "translate(-50%, -50%) rotate(-".concat((activeState.euler.y * 180) / Math.PI + 180, "deg) ") }, directionStyle), children: "N" }), props.isImage && (_jsx("img", { src: "/gaesup-world/canvas.png", className: "minimapObject", style: __assign({ width: "".concat(100 * scale, "rem"), height: "".concat(100 * scale, "rem"), top: "50%", left: "50%", transform: "translate(-50.1%, -50.1%) translate(".concat(activeState.position.x * scale, "rem, ").concat(activeState.position.z, "rem)"), transformOrigin: "50% 50%", zIndex: 100 }, imageStyle) })), Object.values(minimap.props).map(function (_a, key) {
