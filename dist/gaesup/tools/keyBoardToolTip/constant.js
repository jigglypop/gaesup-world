...
export var KeyBoardAll = __assign(__assign(__assign(__assign(__assign(__assign(__assign({}, KeyboardF), KeyboardOne), KeyboardTwo), KeyboardThree), KeyboardFour), KeyboardFive), KeyboardArrow);
