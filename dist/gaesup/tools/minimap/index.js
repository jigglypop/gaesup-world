...
export function MiniMap(props) {
    ...
    return (_jsxs("div", { className: "minimap", onWheel: function (e) {
            ...
            if (e.deltaY <= 0)
                ...
                downscale();
        }, children: [_jsx("div", { className: "minimapOuter", style: objectStyle }), _jsxs("div", { className: "minimapInner", style: __assign({ 
                    // transform: props.blockRotate
                    //   ? `translate(-50%, -50%) rotate(180deg) `
                    //   : `translate(-50%, -50%) rotate(${
                    //       (activeState.euler.y * 180) / Math.PI + 180
                    //     }deg) `,
                    transform: "translate(-50%, -50%) rotate(180deg)" }, innerStyle), children: [_jsx("div", { className: "east direction", style: __assign({ transform: "translate(-50%, 50%) rotate(180deg)" }, directionStyle), children: "E" }), _jsx("div", { className: "west direction", style: __assign({ transform: "translate(50%, 50%) rotate(180deg)" }, directionStyle), children: "W" }), _jsx("div", { className: "south direction", style: __assign({ transform: "translate(-50%, 50%) rotate(180deg)" }, directionStyle), children: "S" }), _jsx("div", { className: "north direction", style: __assign({ transform: "translate(-50%, -50%) rotate(180deg)" }, directionStyle), children: "N" }), Object.values(minimap.props).map(function (_a, key) {
