...
export function MiniMap(props) {
    ...
    return (_jsxs("div", { className: style.minimap, onWheel: function (e) {
            ...
            if (e.deltaY <= 0)
                ...
                downscale();
        }, style: assignInlineVars(minimapStyle), children: [_jsx("div", { className: style.minimapOuter, style: assignInlineVars(objectStyle) }), _jsxs("div", { className: style.minimapInner, style: assignInlineVars(__assign({ transform: "translate(-50%, -50%) rotate(".concat((activeState.euler.y * 180) / Math.PI, "deg) ") }, innerStyle)), children: [_jsx("div", { className: style.direction({
                            east: true,
                        ...
                        return (_jsx("div", { className: style.minimapObject, style: assignInlineVars({
                                ...
                                top: "50%",
                                left: "50%",
                                transform: "translate(-50%, -50%) translate(".concat(-X, "rem, ").concat(-Z, "rem)"),
                                transformOrigin: "50% 50%",
                            }), children: _jsx("div", { className: style.text, style: assignInlineVars(textStyle), children: text }) }, key));
                    }), _jsx("div", { className: style.avatar, style: assignInlineVars(avatarStyle) })] }), _jsxs("div", { className: style.scale, style: assignInlineVars(scaleStyle), children: [_jsx("div", { className: style.plusMinus, style: assignInlineVars(plusMinusStyle), onClick: function () {
                            if (props.blockScale)
                                return;
                            downscale();
