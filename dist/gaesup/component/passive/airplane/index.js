...
export function PassiveAirplane(_a) {
    var _b;
    var props = _a.props;
    ...
    return (_jsx(PassiveWrapperRef, { props: props, refs: refs, url: (_b = props.url) === null || _b === void 0 ? void 0 : _b.airplaneUrl, children: _jsx(AirplaneCollider, { collider: props.airplaneCollider }) }));
}
