...
export function GaesupController(props) {
    ...
    var prop = __assign(__assign(__assign({}, initControllerProps({
        props: props,
        refs: refs,
    })), { callbacks: {
        ...
        }, children: props.children, groupProps: props.groupProps, isRider: props.isRider !== null ? props.isRider : false }), refs);
    return (_jsxs(GaesupControllerContext.Provider, { value: gaesupControl.value, children: [_jsx(Camera, { refs: refs, prop: prop, control: prop.keyControl }), _jsxs(GaesupControllerDispatchContext.Provider, { value: gaesupControl.dispatch, children: [mode.type === "character" && (_jsx(Character, { controllerProps: prop, refs: refs })), mode.type === "vehicle" && (_jsx(Vehicle, { controllerProps: prop, refs: refs })), mode.type === "airplane" && (_jsx(Airplane, { controllerProps: prop, refs: refs }))] })] }));
}
