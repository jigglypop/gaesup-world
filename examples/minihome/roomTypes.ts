...
export const DEFAULT_ROOM_SETTINGS: Readonly<RoomSettings> = Object.freeze({ quality: 'balanced', lighting: 'day', camera: 'isometric', avatar: 'classic', sound: 'calm', volume: 0.35, projection: 'orthographic', pan: true, rotate: true, damping: true, moveSpeed: 3.5, natureMotion: true, weather: 'clear', bloom: true, bloomStrength: 0.6, bloomRadius: 0.4, bloomThreshold: 1.2 });
