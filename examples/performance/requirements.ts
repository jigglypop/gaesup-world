...
const evidence: Record<string, NonNullable<Requirement['evidence']>> = {
  R25: { baselineRunId: '5ef8b6be-5e40-44a2-9c45-3c139427a093', candidateRunId: '5590b003-54f1-4982-b298-8e8212d90a7f', note: '월드별 상태·입력·오디오·grass·WorldBridge·NPC·상호작용·시네마틱 수명을 연결했습니다. 게임패드 공유 폴링 1회/프레임, 실제 Rapier 절반/최대 입력 속도 약 5/10 world/s입니다. 복원 관찰자 구독 공유·지연 읽기 세대·부분 적용 취소를 검사합니다. world-save-hooks에서 잘못된 전역 저장 3→0, save-hook-sharing에서 중복 읽기 2→1·연속 요청의 쓰기/직렬화 12→2를 확인합니다. 시네마틱 등 비동기 효과와 복원의 경합, 공통 clock·엔티티/권위 명령 계약, 실제 USB/Bluetooth 장치 검증은 남아 있습니다.' },
