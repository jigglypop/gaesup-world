...
import { PartsGroupRef } from "./partsGroupRef";
import { setGroundRay } from "./setGroundRay";
export const RigidBodyRef = forwardRef((props, ref) => {
    var _a;
    const { size } = useGltfAndSize({ url: props.url });
    props.groundRay &&
        setGroundRay({
